...
<form id="edit-carrier-template-form" method="post" action="postback">
  <div class="form-group">
    <textarea id="html_body" name="html_body" style="height: 300px; width: 100%">{{ m.onbill[{carrier_template carrier_id=carrier_id template_id=q.template_id}] }}</textarea>
    <input id="carrier_id" type="hidden" name="carrier_id" value={{ carrier_id }} />
