...
<table class="table table-condensed table-centered">
        ...
        <tr><th colspan="2">
            ...
            %}
              <span id="arrows_{{ #id }}" style="cursor: pointer;">
                <i id="arrow_right_{{ #id }}" style="{% if m.kazoo[{ui_element_opened element="contacts_widget_opened"}] %}display: none;{% endif %}" 
                                                class="arrowpad fa fa-arrow-circle-right"></i>
                <i id="arrow_down_{{ #id }}" style="{% if not m.kazoo[{ui_element_opened element="contacts_widget_opened"}] %}display: none;{% endif %}" 
    ...
    <tbody id="contacts_widget_opened" style="border-top: 0px;{% if not m.kazoo[{ui_element_opened element="contacts_widget_opened"}] %}display: none;{% endif %}">
