    ...
    <tbody id="mytbodyid">
        {% for number in free_numbers %}
            <tr>
               ...
               <td class="td-center">{{ m.config.mod_kazoo.local_currency_sign.value }}{{ number["activation_charge"]|inno_activation_calc|format_price }}</td>
               <td class="td-center">{{ m.config.mod_kazoo.local_currency_sign.value }}2.00</td>
               {% if card_exists and plan_applied %}
               <td class="td-center">{% button class="btn btn-xs btn-onnet" text=_"purchase" 
