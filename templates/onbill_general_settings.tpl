...
%}
  <span id="arrows_{{ #dtid }}" style="cursor: pointer;">
    ...
    {{ headline }}
    {% button class="btn btn-xs btn-onnet pull-right" text=_"save" id="save_json_onbill_general_settings"
              action={ dialog_open title=_"Account level call restrictions" template="admin_portal_account_restrictions.tpl" class="iamclass" } %}
    {% button class="btn btn-xs btn-onnet pull-right" text=_"restore" id="restore_json_onbill_general_settings"
