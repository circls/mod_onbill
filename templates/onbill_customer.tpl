...
{% wire id="arrows_"++#dtid type="click"
        action={ toggle target="onbill_customer_"++account_id++"_widget_opened" }
...
%}
  <span id="arrows_{{ #dtid }}" style="cursor: pointer;">
    ...
    {% button class="btn btn-xs btn-onnet pull-right display_none" text=_"save" id="save_json_"++account_id
              action={postback postback={onbill_set_doc_json doc_id=account_id doc_type="customer"}
...
<div id="onbill_customer_{{ account_id }}_widget_opened"
     style="display: none;"
>
    <div class="text-center p-3">
        {% ilazy class="fa fa-spinner fa-spin fa-3x" action={update target="onbill_customer_"++account_id++"_widget_opened"
