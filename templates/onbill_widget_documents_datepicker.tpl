...
{% block widget_headline %}
    {{ headline }}
    {% button class="btn btn-xs btn-onnet pull-right" action={postback postback="refresh_onbill_docs" delegate="mod_onbill" qarg="docsmonthInput"} text=_"refresh results" %}
{% endblock %}
