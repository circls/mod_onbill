...
<form id="form_periodic_fee" method="post" action="postback">
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-sm-4">
          <label for="service_endless" class="checkbox-inline {% if fee_data[1]["service_ends"] %}checked{% endif %}" style="width: 100%">
            <input type="checkbox" id="service_endless" name="service_endless"
                   value="{{ fee_data[1]["service_ends"] }}" {% if fee_data[1]["service_ends"] %}checked{% endif %}>
            {_ End date _}
          </label>
        </div>
        <div class="col-sm-4">
